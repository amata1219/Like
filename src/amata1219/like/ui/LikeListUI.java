...
public abstract class LikeListUI extends AbstractMultipleUI {
	
	protected final UUID owner;
	
	protected LikeListUI(UUID owner){
		this.owner = owner;
	}
	
	protected void putPageNavigationButtons(Player p, Layout l, Type type){
		if(type == Type.FIRST){
			l.put(s -> {
				s.icon(i -> {
	...
	protected void putSortButtons(Player p, Layout l){
